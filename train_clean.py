...
parser = argparse.ArgumentParser(description='Train clean models for evaluation')
...
if not os.path.isdir('{}_clean'.format(args.dataset)):
    os.mkdir('{}_clean'.format(args.dataset))
...
for i in range(args.n_model):
    ...
    # Save model
    torch.save(net.state_dict(), './{}_clean/model_{}.pth'.format(args.dataset, i))
